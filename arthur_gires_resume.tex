...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Pre-sales Quotation Generator .xlsm}
          {Updated the excel worksheet handling pre-sales quotations according to infrastructure PM's experiences.\\
        ...
        \resumeItem{MC80a Home One Tydirium}
          {Architected an end-to-end multi-layer routing and pricing ecosystem, version controlled and packaged (git / docker).\\
          Built a REST-like API (FastAPI / PostGIS) backend and a dedicated PyQGIS front-end plugin for Pre-sales teams.\\
